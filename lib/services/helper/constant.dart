...
const String SEARCHQUOTE = "https://api.quotable.io/search/quotes?query=";
const String LIMITAPI =
    "https://api.quotable.io/search/quotes?query=love&limit=10";
const String AUTHORAPI = "https://api.quotable.io/search/authors?query=";
const String AUTHORQUOTE =
